...
SOLID_PHASE_SELECT: SELECT CASE(INDX)
   ...
   CASE(23) ! ADIABATIC SURFACE TEMPERATURE
      ...
      IF (ONE_D%HEAT_TRANS_COEF>0._EB) THEN
         ...
         SOLID_PHASE_OUTPUT = 0.5_EB*(-MMM+SQRT(MAX(0._EB,2._EB*BBB/(AAA*MMM)-MMM**2))) - TMPM
      ELSE
   ...
   CASE(50) ! ADVECTIVE MASS FLUX
      ...
      ELSE
         Y_SPECIES = 1._EB
      ENDIF
      SOLID_PHASE_OUTPUT = -Y_SPECIES*ONE_D%RHO_F*ONE_D%U_NORMAL

   CASE(51)  ! ADVECTIVE HEAT FLUX
      ZZ_GET(1:N_TRACKED_SPECIES) = ONE_D%ZZ_F(1:N_TRACKED_SPECIES)
