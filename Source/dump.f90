...
IF (LEVEL_SET_MODE>0 .AND. LEVEL_SET_TAU_ACCEL>0._EB) WRITE(LU_CORE(NM)) ROS_EFF
...
ENDIF
IF (LEVEL_SET_MODE>0 .AND. LEVEL_SET_TAU_ACCEL>0._EB) READ(LU_RESTART(NM)) ROS_EFF
