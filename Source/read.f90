...
REAL(EB) :: T_DEVC_LINE_END,DT_DEVC_LINE
INTEGER :: N,SIG_FIGS,SIG_FIGS_EXP
CHARACTER(LABEL_LENGTH) :: RAMP_BNDF,RAMP_CPU,RAMP_CTRL,RAMP_DEVC,RAMP_FLUSH,RAMP_GEOM,RAMP_HRR,RAMP_ISOF,RAMP_MASS,&
...
NAMELIST /DUMP/ CFL_FILE,CLIP_RESTART_FILES,COLUMN_DUMP_LIMIT,CTRL_COLUMN_LIMIT,DEVC_COLUMN_LIMIT,&
                DT_BNDF,DT_CPU,DT_CTRL,DT_DEVC,DT_DEVC_LINE,DT_FLUSH,DT_HRR,DT_ISOF,DT_MASS,DT_PART,DT_PL3D,DT_PROF,&
                DT_RADF,DT_RESTART,DT_SL3D,DT_SLCF,DT_SMOKE3D,DT_UVW,EB_PART_FILE,&
                ...
                RAMP_BNDF,RAMP_CPU,RAMP_CTRL,RAMP_DEVC,RAMP_FLUSH,RAMP_GEOM,RAMP_HRR,RAMP_ISOF,RAMP_MASS,&
                RAMP_PART,RAMP_PL3D,RAMP_PROF,RAMP_RADF,RAMP_RESTART,RAMP_SLCF,RAMP_SL3D,RAMP_SMOKE3D,RAMP_UVW,&
                RENDER_FILE,SIG_FIGS,SIG_FIGS_EXP,SMOKE3D,STATUS_FILES,SUPPRESS_DIAGNOSTICS,&
                T_DEVC_LINE_END,TURB_INIT_CLOCK,VELOCITY_ERROR_FILE,WRITE_XYZ,REMOVE_FIREBRANDS
...
READ_SM3D_LOOP: DO N=1,N_SMOKE3D
   ...
   SPEC_ID  = 'null'
   SELECT CASE(N)
      CASE(1) ; QUANTITY='DENSITY' ; SPEC_ID='SOOT'
      CASE(2) ; QUANTITY='HRRPUV'
      CASE(3) ; QUANTITY='TEMPERATURE'
      CASE(4:)
         CALL CHECKREAD('SM3D',LU_INPUT,IOS) ; IF (STOP_STATUS==SETUP_STOP) RETURN
