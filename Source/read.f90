...
REAL(EB), DIMENSION(MAX_REACTIONS) :: A,E,HEATING_RATE,PYROLYSIS_RANGE,HEAT_OF_REACTION, &
          ...
          GAS_DIFFUSION_DEPTH,MAX_REACTION_RATE,SIGMA_E
...
NAMELIST /MATL/ A,ABSORPTION_COEFFICIENT,ADJUST_H,ALLOW_SHRINKING,ALLOW_SWELLING,BOILING_TEMPERATURE,&
                ...
                REFERENCE_RATE,REFERENCE_TEMPERATURE,SIGMA_E,&
...
READ_MATL_LOOP: DO N=1,N_MATL
   ...
   ML%N_LPC=0
   ALLOCATE(ML%SIGMA_E(N_REACTIONS),STAT=IZERO)
   CALL ChkMemErr('READ','ML%SIGMA_E',IZERO)
   ML%SIGMA_E(1:N_REACTIONS)           = SIGMA_E(1:N_REACTIONS)
