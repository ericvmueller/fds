...
NAMELIST /RADI/ ANGLE_INCREMENT,BAND_LIMITS,C_MAX,C_MIN,INITIAL_RADIATION_ITERATIONS,KAPPA0,&
                ...
                OPTICALLY_THIN,PATH_LENGTH,QR_CLIP,RADIATION,RADIATION_ITERATIONS,RADIATION_SCHEME,RADTMP,&
                RANDOMIZE_RADIATION_DIRECTIONS,TIME_STEP_INCREMENT,WIDE_BAND_MODEL,WSGG_MODEL
