...
REAL(EB) :: EMISSIVITY,CONDUCTIVITY,SPECIFIC_HEAT,DENSITY,ABSORPTION_COEFFICIENT,BOILING_TEMPERATURE, &
            PEAK_REACTION_RATE,REFRACTIVE_INDEX,DIFFUSIVITY_SPEC(MAX_SPECIES),POROSITY,MW
...
#ifndef NO_SCARC
USE SCRC, ONLY: SCARC_METHOD, SCARC_MESH, SCARC_TOLERANCE, SCARC_ERROR_FILE, SCARC_VERBOSE, SCARC_COARSE, SCARC_PRECISION, &
                SCARC_KRYLOV_ITERATIONS, SCARC_KRYLOV_TOLERANCE, SCARC_PRECON, SCARC_PRECON_ITERATIONS, SCARC_PRECON_TOLERANCE, &
                SCARC_MGM_BOUNDARY, SCARC_MGM_ITERATIONS, SCARC_MGM_TOLERANCE, SCARC_MGM_LAPLACE_SOLVER
#endif
...
NAMELIST /PRES/ BAROCLINIC,CHECK_POISSON,FISHPAK_BC,ITERATION_SUSPEND_FACTOR,INSEPARABLE_POISSON, &
                SCARC_METHOD, SCARC_MESH, SCARC_TOLERANCE, SCARC_ERROR_FILE, SCARC_VERBOSE, SCARC_COARSE, SCARC_PRECISION, &
                SCARC_KRYLOV_ITERATIONS, SCARC_KRYLOV_TOLERANCE, SCARC_PRECON, SCARC_PRECON_ITERATIONS, SCARC_PRECON_TOLERANCE, &
                SCARC_MGM_BOUNDARY, SCARC_MGM_ITERATIONS, SCARC_MGM_TOLERANCE, SCARC_MGM_LAPLACE_SOLVER, &
...
SELECT CASE(TRIM(SOLVER))
   ...
   CASE('USCARC')
      ...
      IF (SCARC_PRECON == 'NONE') SCARC_PRECON = 'MKL'       ! Use MKL-PARDISO as default preconditioner for USCARC
...
NAMELIST /ZONE/ ID,LEAK_AREA,LEAK_PRESSURE_EXPONENT,LEAK_REFERENCE_PRESSURE,XYZ
