...
NAMELIST /SURF/ ADIABATIC,AREA_MULTIPLIER,BACKING,BLOWING,BLOWING_2,BURN_AWAY,BURN_DURATION,&
                ...
                EMISSIVITY,EMISSIVITY_BACK,EVAC_DEFAULT,EXTERNAL_FLUX,EXTINCTION_TEMPERATURE,&
                FSK_A,FSK_K,FSK_W,&
...
READ_SURF_LOOP: DO N=0,N_SURF
   ...
   SF%EMBER_GENERATION_HEIGHT = EMBER_GENERATION_HEIGHT
   IF (ANY(SF%EMBER_GENERATION_HEIGHT>=0._EB)) THEN
      IF (SF%EMBER_GENERATION_HEIGHT(1)<0._EB) THEN
         SF%EMBER_GENERATION_HEIGHT(1)=0._EB
      ELSEIF (SF%EMBER_GENERATION_HEIGHT(2)<0._EB) THEN
         SF%EMBER_GENERATION_HEIGHT(2)=SF%EMBER_GENERATION_HEIGHT(1)
         SF%EMBER_GENERATION_HEIGHT(1)=0._EB
      ENDIF
   ENDIF   
   ...
   K_MULT_LOOP: DO KK=MR%K_LOWER,MR%K_UPPER
      J_MULT_LOOP: DO JJ=MR%J_LOWER,MR%J_UPPER
         I_MULT_LOOP: DO II=MR%I_LOWER,MR%I_UPPER
            ...
            MESH_LOOP_2: DO NM=1,NMESHES
               IF (DO_EVACUATION) CYCLE MESH_LOOP_2
               M=>MESHES(NM)
