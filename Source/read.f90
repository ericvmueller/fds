...
NAMELIST /MISC/ AEROSOL_AL2O3,AEROSOL_SCRUBBING,AGGLOMERATION,ALIGNMENT_TOLERANCE, &
                ...
                LES_FILTER_TYPE,LEVEL_SET_ELLIPSE_FACTOR,LEVEL_SET_MODE,LEVEL_SET_PROJECTION_MODE,LEVEL_SET_TAU_ACCEL,&
                LEVEL_SET_WIND_FILTER,LEVEL_SET_WIND_TAU,&
...
IF (LEVEL_SET_PROJECTION_MODE<1 .OR. LEVEL_SET_PROJECTION_MODE>3) THEN
   WRITE(MESSAGE,'(A)') 'ERROR(130): LEVEL_SET_PROJECTION_MODE must be 1, 2, or 3.'
   CALL SHUTDOWN(MESSAGE) ; RETURN
ENDIF
...
LOGICAL :: TARGET_ONLY,MASSLESS,STATIC,MONODISPERSE,BREAKUP,CHECK_DISTRIBUTION,DEBUG,&
           TURBULENT_DISPERSION,EMBER_PARTICLE,TRACK_EMBERS,FOUND_IT
...
CHARACTER(LABEL_LENGTH) :: PART_ID,RAMP_MF(MAX_SPECIES),RAMP_Q(MAX_QDOTPP_REF),RAMP_V,RAMP_T,RAMP_T_I,&
                 ...
                 VEG_LSET_WIND_RAMP,VEG_LSET_DYNAMIC_WIND_HEIGHT_RAMP,VEG_LSET_BURNOUT
...
NAMELIST /SURF/ ADIABATIC,ALLOW_SURFACE_PARTICLES,ALLOW_UNDERSIDE_PARTICLES,AREA_MULTIPLIER,BACKING,BLOWING,&
                ...
                VEG_LSET_BETA,VEG_LSET_BURNOUT,VEG_LSET_CHAR_FRACTION,VEG_LSET_FIREBASE_TIME,VEG_LSET_FUEL_INDEX,VEG_LSET_HT,&
                VEG_LSET_IGNITE_TIME,VEG_LSET_M1,VEG_LSET_M10,VEG_LSET_M100,VEG_LSET_MLW,VEG_LSET_MLH,VEG_LSET_QCON,&
                VEG_LSET_ROS_00,VEG_LSET_ROS_FIXED,VEG_LSET_SIGMA,&
                VEG_LSET_SURF_LOAD,VEG_LSET_WIND_RAMP,VEG_LSET_DYNAMIC_WIND_HEIGHT_RAMP,VEG_LSET_WIND_HEIGHT,&
...
READ_SURF_LOOP: DO N=0,N_SURF
   ...
   SELECT CASE(TRIM(VEG_LSET_BURNOUT))
      CASE('TRAPEZOID')
         SF%VEG_LSET_EXPONENTIAL_BURNOUT = .FALSE.
      CASE('EXPONENTIAL')
         SF%VEG_LSET_EXPONENTIAL_BURNOUT = .TRUE.
      CASE DEFAULT
         WRITE(MESSAGE,'(A,A,A)') 'ERROR(383): SURF ',TRIM(SF%ID),&
            ' VEG_LSET_BURNOUT must be TRAPEZOID or EXPONENTIAL.'
         CALL SHUTDOWN(MESSAGE) ; RETURN
   END SELECT
   IF (VEG_LSET_WIND_RAMP/='null') CALL GET_RAMP_INDEX(VEG_LSET_WIND_RAMP,'PROFILE',SF%I_RAMP_LS_WIND)
   IF (VEG_LSET_DYNAMIC_WIND_HEIGHT_RAMP/='null') &
      CALL GET_RAMP_INDEX(VEG_LSET_DYNAMIC_WIND_HEIGHT_RAMP,'PROFILE',SF%I_RAMP_LS_DYNAMIC_WIND_HEIGHT)
...
VEG_LSET_BURNOUT        = 'TRAPEZOID'
VEG_LSET_WIND_RAMP      = 'null'
VEG_LSET_DYNAMIC_WIND_HEIGHT_RAMP = 'null'
