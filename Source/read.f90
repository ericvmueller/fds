...
NAMELIST /MISC/ AEROSOL_AL2O3,AEROSOL_SCRUBBING,AGGLOMERATION,ALIGNMENT_TOLERANCE,ALLOW_SURFACE_PARTICLES, &
                ...
                HUMIDITY,HVAC_LOCAL_PRESSURE,HVAC_MASS_TRANSPORT,HVAC_PRES_RELAX,IBLANK_SMV,&
                ...
                STORE_DIVERGENCE_CORRECTION,TAU_DEFAULT,TERRAIN_CASE,TERRAIN_IMAGE,&
                TEST_NEW_OPEN,TEST_NEW_WAKE_REDUCTION,TEXTURE_ORIGIN,&
...
NAMELIST /WIND/ CORIOLIS_VECTOR,DIRECTION,DT_MEAN_FORCING,DT_MEAN_FORCING_2,FORCE_VECTOR,FYI,GEOSTROPHIC_WIND,GROUND_LEVEL,L,&
                ...
                SPEED,SPONGE_CELLS,STRATIFICATION,TAU_THETA,THETA_STAR,TMP_REF,U_STAR,U0,USE_ATMOSPHERIC_INTERPOLATION,&
                V0,W0,Z_0,Z_REF,&
                MEAN_FORCING  ! Backward compatibility
...
REAL(EB) :: EMISSIVITY,CONDUCTIVITY,SPECIFIC_HEAT,DENSITY,ABSORPTION_COEFFICIENT,BOILING_TEMPERATURE, &
            PEAK_REACTION_RATE,REFRACTIVE_INDEX,DIFFUSIVITY_SPEC(MAX_SPECIES),POROSITY,PERMEABILITY
...
NAMELIST /MATL/ A,ABSORPTION_COEFFICIENT,ALLOW_SHRINKING,ALLOW_SWELLING,BETA_CHAR,BOILING_TEMPERATURE,&
                ...
                N_O2,N_REACTIONS,N_S,N_T,NU_MATL,NU_O2_CHAR,NU_SPEC,PCR,PERMEABILITY,&
...
CHARACTER(LABEL_LENGTH) :: PART_ID,RAMP_MF(MAX_SPECIES),RAMP_Q,RAMP_V,RAMP_T,MATL_ID(MAX_LAYERS,MAX_MATERIALS),&
                 PROFILE,BACKING,GEOMETRY,NAME_LIST(MAX_MATERIALS*MAX_LAYERS),RAMP_EF,RAMP_PART,&
...
REAL(EB) :: TAU_Q,TAU_V,TAU_T,TAU_MF(MAX_SPECIES),HRRPUA,MLRPUA,TEXTURE_WIDTH,TEXTURE_HEIGHT,VEL_T(2),&
            ...
            Z_0,PARTICLE_EXTRACTION_VELOCITY
...
NAMELIST /CLIP/ FYI,MAXIMUM_DENSITY,MAXIMUM_TEMPERATURE,MINIMUM_DENSITY,MINIMUM_TEMPERATURE,CLIP_DT_RESTRICTIONS_MAX
