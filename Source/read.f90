...
LOGICAL :: TARGET_ONLY,MASSLESS,STATIC,MONODISPERSE,BREAKUP,CHECK_DISTRIBUTION,TURBULENT_DISPERSION,&
           SECOND_ORDER_PARTICLE_TRANSPORT,EMBER_PARTICLE,ADHERE_TO_SOLID
...
NAMELIST /PART/ ADHERE_TO_SOLID,AGE,BREAKUP,BREAKUP_CNF_RAMP_ID,BREAKUP_DISTRIBUTION,BREAKUP_GAMMA_D,BREAKUP_RATIO,&
                ...
                HORIZONTAL_VELOCITY,ID,INITIAL_TEMPERATURE,KILL_DIAMETER,MASSLESS,MASS_TRANSFER_COEFFICIENT,MAXIMUM_DIAMETER,&
...
NAMELIST /SURF/ ADIABATIC,AERODYNAMIC_ROUGHNESS,AREA_MULTIPLIER,BACKING,BLOWING,BURN_AWAY,BURN_DURATION,CELL_SIZE_FACTOR,&
