...
NAMELIST /SPEC/ AEROSOL,ALT_ID,BACKGROUND,BETA_LIQUID,C,CONDUCTIVITY,CONDUCTIVITY_LIQUID,CONDUCTIVITY_SOLID,COPY_LUMPED, &
...
DO N1 = 1, N_TRACKED_SPECIES
   SPECIES_MIXTURE(N1)%OXR = 2*(SPECIES_MIXTURE(N1)%ATOMS(1) * 0.25_EB + SPECIES_MIXTURE(N1)%ATOMS(6)) &
...
USE CHEMCONS, ONLY: ODE_MIN_ATOL, EQUIV_RATIO_CHECK, MIN_EQUIV_RATIO, MAX_EQUIV_RATIO
REAL(EB) :: ODE_REL_ERROR
NAMELIST /COMB/ CHECK_REALIZABILITY,COMPUTE_ADIABATIC_FLAME_TEMPERATURE, EQUIV_RATIO_CHECK, &
...
REAL(EB) :: K_S_0,C_S_0,DENSITY_MIN
...
NAMELIST /RADI/ ANGLE_INCREMENT,BAND_LIMITS,C_MAX,C_MIN,INITIAL_RADIATION_ITERATIONS,KAPPA0,&
                ...
                TIME_STEP_INCREMENT,WIDE_BAND_MODEL,WSGG_MODEL,SUBRAD_MODEL
...
PROF_LOOP: DO NN=1,N_PROFO
   ...
   CALL GET_QUANTITY_INDEX(LABEL_DUM(1),LABEL_DUM(2),PF%QUANTITY_INDEX,I_DUM(1), &
                           ...
                           I_DUM(8),'PROF', &
                           PF%QUANTITY,'null','null','null','null','null','null',MATL_ID,&
                           -1._EB,I_DUM(9))
