...
INTEGER, PARAMETER :: N_ONE_D_SCALAR_REALS=25,N_ONE_D_SCALAR_INTEGERS=10,N_ONE_D_SCALAR_LOGICALS=2
...
TYPE WALL_TYPE
   TYPE (ONE_D_M_AND_E_XFER_TYPE) :: ONE_D
   REAL(EB), POINTER, DIMENSION(:) :: A_LP_MPUA,AWM_AEROSOL,LP_CPUA,LP_MPUA
...
TYPE MATERIAL_TYPE
   REAL(EB) :: K_S,C_S,RHO_S,EMISSIVITY,THERMAL_DIFFUSIVITY,KAPPA_S,TMP_BOIL,POROSITY,REFRACTIVE_INDEX
...
TYPE SURFACE_TYPE
   REAL(EB) :: TMP_FRONT=-1._EB,TMP_BACK=-1._EB,VEL,VEL_GRAD,PLE,Z0,CONVECTIVE_HEAT_FLUX,NET_HEAT_FLUX, &
               ...
               AREA_ADJUST=1._EB,PARTICLE_SURFACE_DENSITY=-1._EB,DRAG_COEFFICIENT=2.8_EB,SHAPE_FACTOR=0.25_EB
...
TYPE INITIALIZATION_TYPE
   ...
   INTEGER  :: PART_INDEX=0,N_PARTICLES,LU_PARTICLE,PROF_INDEX=0,DEVC_INDEX=0,CTRL_INDEX=0,TABL_INDEX=0, &
               N_PARTICLES_PER_CELL=0,PATH_RAMP_INDEX(3)=0
