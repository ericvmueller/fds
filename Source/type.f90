...
INTEGER, PARAMETER :: N_WALL_SCALAR_REALS=15,N_WALL_SCALAR_INTEGERS=15,N_WALL_SCALAR_LOGICALS=0

TYPE WALL_TYPE
   TYPE (ONE_D_M_AND_E_XFER_TYPE) :: ONE_D
   REAL(EB), POINTER, DIMENSION(:) :: A_LP_MPUA,AWM_AEROSOL,LP_CPUA,LP_MPUA,VEG_FUELMASS_L,VEG_MOISTMASS_L,VEG_TMP_L
   REAL(EB), POINTER :: AW,DUWDT,EW,KW,Q_LEAK,U_TAU,UVW_GHOST,UW0,V_DEP,VEG_HEIGHT,VEL_ERR_NEW,XW,Y_PLUS,YW,ZW
