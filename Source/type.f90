...
INTEGER, PARAMETER :: N_ONE_D_SCALAR_REALS=37,N_ONE_D_SCALAR_INTEGERS=12,N_ONE_D_SCALAR_LOGICALS=1
...
TYPE MATERIAL_TYPE
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: NU_GAS,ADJUST_BURN_RATE,NU_LPC
   REAL(EB), ALLOCATABLE, DIMENSION(:) :: DIFFUSIVITY_GAS,H
