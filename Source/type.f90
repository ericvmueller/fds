...
TYPE SURFACE_TYPE
   ...
   LOGICAL :: VEG_LSET_EXPONENTIAL_BURNOUT=.FALSE.  !< T => convolution of cell fill with exp. burnout (WRF-like)
   ...
   INTEGER :: VEG_LSET_FUEL_INDEX,I_RAMP_LS_WIND=-1,I_RAMP_LS_DYNAMIC_WIND_HEIGHT=-1
