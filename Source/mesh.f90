...
TYPE MESH_TYPE
   ...
   REAL(EB) :: CFL,DIVMX,DIVMN,VN,RESMAX,DRAG_STABILITY_MAX=0._EB,PART_UVWMAX=0._EB
...
REAL(EB), POINTER :: CFL,DIVMX,DIVMN,VN,RESMAX,DRAG_STABILITY_MAX,PART_UVWMAX
...
RESMAX=>M%RESMAX
DIVMN=>M%DIVMN
DRAG_STABILITY_MAX=>M%DRAG_STABILITY_MAX
