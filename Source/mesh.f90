...
TYPE MESH_TYPE
   ...
   INTEGER :: N_CC_ELIMINATED=0
   INTEGER,  ALLOCATABLE, DIMENSION(:,:) :: JBT_CC_BLOCKED
   REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: XYZ_CC_BLOCKED
   INTEGER,  ALLOCATABLE, DIMENSION(:,:) :: JBT_CC_ELIMINATED
   REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: XYZ_CC_ELIMINATED
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: FLUX0_LS,FLUX1_LS,PHI_LS,PHI1_LS, &
                                            ...
                                            PHI_S_X,PHI_S_Y,PHI_W,LS_WORK1,LS_WORK2,ROS_LAG
