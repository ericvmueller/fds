...
CHARACTER(LABEL_LENGTH) :: PLOT3D_SMOKEVIEW_LABEL(5),SMOKE3D_SMOKEVIEW_LABEL(4)
...
OUTPUT_QUANTITY(99)%NAME  = 'ZONE PRESSURE SOLVER TYPE'
OUTPUT_QUANTITY(99)%UNITS  = ' '
OUTPUT_QUANTITY(99)%SHORT_NAME  = 'pres_flag'
...
OUTPUT_QUANTITY(252)%NAME  = 'AUTO IGNITION TEMPERATURE'
OUTPUT_QUANTITY(252)%UNITS = 'C'
OUTPUT_QUANTITY(252)%SHORT_NAME  = 'ait'
OUTPUT_QUANTITY(252)%SLCF_APPROPRIATE=.TRUE.
OUTPUT_QUANTITY(252)%ISOF_APPROPRIATE=.TRUE.
...
OUTPUT_QUANTITY(341)%NAME = 'NODE SENSIBLE ENTHALPY'
OUTPUT_QUANTITY(341)%UNITS = 'kJ/kg'
OUTPUT_QUANTITY(341)%SHORT_NAME = 'h_sens,n'
OUTPUT_QUANTITY(341)%NODE_ID_REQUIRED=.TRUE.
...
OUTPUT_QUANTITY(454)%NAME = 'DISK AREA'
OUTPUT_QUANTITY(454)%UNITS = 'm^2'
OUTPUT_QUANTITY(454)%SHORT_NAME = 'da'

OUTPUT_QUANTITY(434:454)%PART_APPROPRIATE = .TRUE.
OUTPUT_QUANTITY(434:454)%SLCF_APPROPRIATE = .FALSE.
OUTPUT_QUANTITY(434:454)%DEVC_APPROPRIATE = .TRUE.
...
OUTPUT_QUANTITY(538)%NAME = 'PYRO3D IOR'
OUTPUT_QUANTITY(538)%UNITS = ''
OUTPUT_QUANTITY(538)%SHORT_NAME = 'pyro3d ior'

OUTPUT_QUANTITY(539)%NAME = 'MEAN FORCING CELL'
OUTPUT_QUANTITY(539)%UNITS = ''
OUTPUT_QUANTITY(539)%SHORT_NAME = 'mfc'

OUTPUT_QUANTITY(540)%NAME = 'SOLID CELL CONDUCTIVITY'
OUTPUT_QUANTITY(540)%UNITS = 'W/m/K'
OUTPUT_QUANTITY(540)%SHORT_NAME = 'k_s'

OUTPUT_QUANTITY(541)%NAME = 'SOLID CELL SPECIFIC HEAT'
OUTPUT_QUANTITY(541)%UNITS = 'kJ/kg/K'
OUTPUT_QUANTITY(541)%SHORT_NAME = 'c_s'
...
OUTPUT_QUANTITY(-71)%NAME = 'OBUKHOV LENGTH'
OUTPUT_QUANTITY(-71)%UNITS= 'm'
OUTPUT_QUANTITY(-71)%SHORT_NAME = 'L'
...
SELECT CASE (SPEC_ID_USE)
   ...
   CASE('N-HEXANE') !NASA/TP-2002-211556
      ...
      FUEL = .TRUE.
   CASE('N-PENTANE') !NASA/TP-2002-211556
      TE = MIN(6000._EB,MAX(TE,200._EB))
      IF (TE<1000._EB) THEN
      CP = -276889.4625_EB*TE**(-2)+5834.28347_EB/TE-36.1754148_EB+0.1533339707_EB*TE-0.0001528395882_EB*TE**2+&
         0.00000008191092_EB*TE**3-1.792327902E-11_EB*TE**4
      ELSE
      CP = -2530779.286_EB*TE**(-2)-8972.59326_EB/TE+45.3622326_EB-0.002626989916_EB*TE+0.000003135136419_EB*TE**2 &
         -0.000000000531872894_EB*TE**3+2.886896868E-14_EB*TE**4
      ENDIF
      CP = CP * 8314.472_EB / 72.14878_EB !J/kg/K
      H = -2437636.9455429_EB !J/kg
...
SELECT CASE (SPEC_ID)
   ...
   CASE('N-HEXANE') !NASA/TP-2002-211556
      ...
      BETA = 0.00138_EB !1/K
   CASE('N-PENTANE') ! JPCRD 6
      T = MIN(390._EB,MAX(REAL(I_TMP,EB),150._EB))
      CP =2454.7_EB-6.8347_EB*T+0.025884_EB*T**2-0.000015115_EB*T**3
      H_L = -3007126.66064534_EB !J/kg
      H_V = 370582.470209505_EB !J/kg
      T_REF = 298.15_EB !K
      T_MELT = 143.35_EB !K
      T_BOIL = 309.25_EB !K
      DENSITY = 621._EB !kg/m^3
      FUEL = .TRUE.
      K = 0.148_EB !W/m/K
      MU = 0.000245_EB !N.s/m^2
      BETA = 0.00163_EB !1/K
   CASE('N-OCTANE') !NASA/TP-2002-211556
...
GAS_NAME_SELECT: SELECT CASE(GAS_NAME)
   ...
   CASE('N-PENTANE')
      ...
      EPSOK = 341.1_EB
      FORMULA = 'C5H12'
      H_F = -146.76_EB !NASA/TP-2002-211556
      PR_GAS = 0.79 ! Hexane value assumed
      IF (RADCAL_NAME=='null') RADCAL_NAME='N-HEPTANE'
   CASE('N-OCTANE')
      SIGMA = 4.892_EB
      EPSOK = 231.16_EB
