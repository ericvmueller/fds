...
OUTPUT_QUANTITY(447)%NAME = 'DISK AREA'
OUTPUT_QUANTITY(447)%UNITS = 'm^2'
OUTPUT_QUANTITY(447)%SHORT_NAME = 'da'

OUTPUT_QUANTITY(434:447)%PART_APPROPRIATE = .TRUE.
OUTPUT_QUANTITY(434:447)%SLCF_APPROPRIATE = .FALSE.
OUTPUT_QUANTITY(434:447)%DEVC_APPROPRIATE = .TRUE.
