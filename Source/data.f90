...
OUTPUT_QUANTITY(455)%NAME = 'DISK AREA'
OUTPUT_QUANTITY(455)%UNITS = 'm^2'
OUTPUT_QUANTITY(455)%SHORT_NAME = 'da'

OUTPUT_QUANTITY(434:455)%PART_APPROPRIATE = .TRUE.
OUTPUT_QUANTITY(434:455)%SLCF_APPROPRIATE = .FALSE.
OUTPUT_QUANTITY(434:455)%DEVC_APPROPRIATE = .TRUE.
