...
OUTPUT_QUANTITY(453)%NAME = 'DISK AREA'
OUTPUT_QUANTITY(453)%UNITS = 'm^2'
OUTPUT_QUANTITY(453)%SHORT_NAME = 'da'

OUTPUT_QUANTITY(434:453)%PART_APPROPRIATE = .TRUE.
OUTPUT_QUANTITY(434:453)%SLCF_APPROPRIATE = .FALSE.
OUTPUT_QUANTITY(434:453)%DEVC_APPROPRIATE = .TRUE.
