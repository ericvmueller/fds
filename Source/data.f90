...
OUTPUT_QUANTITY(-50)%NAME = 'ADVECTIVE MASS FLUX'
OUTPUT_QUANTITY(-50)%UNITS= 'kg/m2/s'
OUTPUT_QUANTITY(-50)%SHORT_NAME = 'mf'

OUTPUT_QUANTITY(-51)%NAME = 'ADVECTIVE HEAT FLUX'
