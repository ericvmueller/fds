...
REAL(EB) :: DRAG_CFL_MAX=0.2_EB                !< Upper limit of CFL constraint based on drag force
REAL(EB) :: DRAG_CFL_MIN=0.1_EB                !< Lower limit of CFL constraint based on drag force
