...
INTEGER, PARAMETER :: H_CUSTOM=-1,H_DEFAULT=0,H_LOGLAW=1,H_ABL=2,H_RAYLEIGH=3,H_YUAN=4,&
                      H_FREE_HORIZONTAL_CYLINDER=5                                          ! Heat transfer coefficient model
...
INTEGER, PARAMETER :: SPHERE_DRAG=1,CYLINDER_DRAG=2,USER_DRAG=3,SCREEN_DRAG=4, &            ! Options for drag computation
                      POROUS_DRAG=5,DISK_DRAG=6 
...
LOGICAL :: RADIATION=.TRUE.,RADIATION_COMPLETED=.TRUE.,EXCHANGE_RADIATION=.FALSE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE, &
           ...
           CHECK_HT=.FALSE.,PATCH_VELOCITY=.FALSE.,OVERWRITE=.TRUE.,INIT_HRRPUV=.FALSE., &
           ...
           GEOM_DIAG=.FALSE.,SUPPRESS_DIAGNOSTICS=.FALSE.,WRITE_GEOM_FIRST=.TRUE.,&
           ...
           TRI_MODEL=.FALSE.,FLAME_INDEX_MODEL=.FALSE.,STORE_SPECIES_FLUX=.FALSE.,FBRAND=.TRUE.
...
CHARACTER(255) :: CHID,RESTART_CHID
...
REAL(EB) :: Y_O2_INFTY=0.232378_EB,Y_CO2_INFTY=0.000595_EB,Y_H2O_INFTY=0._EB,&
            ...
            AUTO_IGNITION_TEMPERATURE=0._EB,AIT_EXCLUSION_ZONE(6)=-1.E6_EB, &
            LAMINAR_FLAME_SPEED=0.4_EB,HRRPUV_CUT,HRRPUV_CUT_MAX=200._EB
...
INTEGER :: N_SPECIES=0,N_REACTIONS,I_PRODUCTS=-1,I_WATER=-1,I_CO2=-1,N_TRACKED_SPECIES=0,N_SURFACE_DENSITY_SPECIES=0,&
           ...
           N_PASSIVE_SCALARS=0,N_TOTAL_SCALARS=0,N_FIXED_CHEMISTRY_SUBSTEPS=-1,USE_HRRPUV_MAX_SMV=0,USE_TEMP_MAX_SMV=0
...
INTEGER :: NUMBER_SPECTRAL_BANDS=0,NUMBER_RADIATION_ANGLES=0,ANGLE_INCREMENT=0,RADIATION_ITERATIONS=1, &
           INITIAL_RADIATION_ITERATIONS,NUMBER_INITIAL_ITERATIONS,NUMBER_FSK_POINTS=1
...
REAL(EB) :: DT_SLCF,DT_BNDE,DT_BNDF,DT_DEVC,DT_PL3D,DT_PART,DT_RESTART,DT_ISOF,DT_HRR,DT_MASS,DT_PROF,DT_CTRL,&
            DT_FLUSH,DT_SL3D,DT_GEOM,DT_CPU,DT_RADF
...
INTEGER                              :: LU_ERR=0,LU_END=2,LU_GIT=3,LU_SMV=4,LU_INPUT=5,LU_OUTPUT=6,LU_STOP=7,LU_CPU=8,&
                                        LU_CATF=9
INTEGER                              :: LU_MASS,LU_HRR,LU_NOTREADY,LU_VELOCITY_ERROR,LU_CFL,LU_LINE=-1,LU_CUTCELL
...
INTEGER, ALLOCATABLE, DIMENSION(:)   :: LU_VEG_OUT,LU_GEOM,LU_BNDE,LU_FBRAND
...
CHARACTER(80)                              :: FN_MASS,FN_HRR,FN_SMV,FN_END,FN_ERR,FN_NOTREADY,FN_VELOCITY_ERROR,FN_GIT
...
CHARACTER(80), ALLOCATABLE, DIMENSION(:)   :: FN_VEG_OUT,FN_GEOM,FN_BNDE,FN_FBRAND
CHARACTER(80)                              :: FN_GEOM_DIAG(2)
CHARACTER(80), ALLOCATABLE, DIMENSION(:,:) :: FN_SLCF,FN_SLCF_GEOM,FN_BNDF,FN_BNDF_GEOM,FN_BNDG, &
                                              FN_ISOF,FN_ISOF2,FN_SMOKE3D,FN_BNDF_SLCF,FN_RADF
...
INTEGER :: N_VENT_TOTAL=0,SPONGE_CELLS
REAL(EB) :: U_MEAN_GLOBAL=0._EB,V_MEAN_GLOBAL=0._EB,W_MEAN_GLOBAL=0._EB
REAL(EB), ALLOCATABLE, DIMENSION(:) :: U_MEAN_LOC,V_MEAN_LOC,W_MEAN_LOC,&
                                       M_VOLU_LOC,M_VOLV_LOC,M_VOLW_LOC
...
INTEGER :: MAXIMUM_PARTICLES,N_LAGRANGIAN_CLASSES,N_EVAC,N_LP_ARRAY_INDICES=0,N_INITIAL_PARTICLE_SUBSTEPS=1
