...
INTEGER, PARAMETER :: SPHERE_DRAG=1,CYLINDER_DRAG=2,USER_DRAG=3,SCREEN_DRAG=4, &
                      POROUS_DRAG=5,DISK_DRAG=6                                             ! Options for drag computation
...
LOGICAL :: LES,DNS,RADIATION=.TRUE.,RADIATION_COMPLETED=.TRUE.,EXCHANGE_RADIATION=.FALSE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE, &
           ...
           NEW_MOMENTUM_NUDGING=.FALSE.,CORRECT_SUBGRID_TEMPERATURE=.FALSE.,STORE_OLD_VELOCITY=.FALSE.,FBRAND=.TRUE.
...
INTEGER, ALLOCATABLE, DIMENSION(:,:) :: LU_SLCF,LU_SLCF_GEOM,LU_BNDF,LU_BNDF_GEOM,LU_BNDG,LU_ISOF, &
                                        LU_SMOKE3D,LU_BNDF_SLCF
...
CHARACTER(80), ALLOCATABLE, DIMENSION(:,:) :: FN_SLCF,FN_SLCF_GEOM,FN_BNDF,FN_BNDF_GEOM,FN_BNDG, &
                                              FN_ISOF,FN_SMOKE3D,FN_BNDF_SLCF
