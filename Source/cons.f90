...
LOGICAL :: INTERPOLATE_PART_INTENSITY=.FALSE. !< Apply subgrid interpolation of radiant intensity to particle clouds
...
INTEGER :: RADIATION_SCHEME=1                              !< Scheme for FVM numerics. 1=upwind; 2=diamond; 3=hybrid
...
INTEGER, ALLOCATABLE, DIMENSION(:) :: LP_INTERP_INDICES
