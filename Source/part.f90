...
IF (LPC%SUBGRID_INTERPOLATION) B1%U_TANG = QREL
...
ELSE
   ...
   FVX_D(BC%IIG-1:BC%IIG,BC%JJG,BC%KKG) = FVX_D(BC%IIG-1:BC%IIG,BC%JJG,BC%KKG) - 0.5_EB*ACCEL_X
   FVY_D(BC%IIG,BC%JJG-1:BC%JJG,BC%KKG) = FVY_D(BC%IIG,BC%JJG-1:BC%JJG,BC%KKG) - 0.5_EB*ACCEL_Y
   FVZ_D(BC%IIG,BC%JJG,BC%KKG-1:BC%KKG) = FVZ_D(BC%IIG,BC%JJG,BC%KKG-1:BC%KKG) - 0.5_EB*ACCEL_Z
ENDIF
