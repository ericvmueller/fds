...
SUBROUTINE VELOCITY_BC(DT,T,NM,APPLY_TO_ESTIMATED_VARIABLES)
...
REAL(EB) :: MUA,TSI,WGT,T_NOW,RAMP_T,OMW,MU_WALL,RHO_WALL,SLIP_COEF,VEL_T, &
            ...
            DRAG_FACTOR,HT_SCALE_FACTOR,VEG_HT,MAX_STRESS
         ...
         INTERPOLATION_IF: IF (NOM(ICD)==0 .OR. &
            ...
            BOUNDARY_CONDITION: SELECT CASE(VELOCITY_BC_INDEX)
               ...
               CASE (BOUNDARY_FUEL_MODEL_BC) BOUNDARY_CONDITION
                  ...
                  ! Limit stress to avoid flow reversal
                  MAX_STRESS = ABS(RHO_WALL*VEG_HT*VEL_GAS*HT_SCALE_FACTOR/DT)
                  MU_DUIDXJ(ICD_SGN) = MIN(MAX_STRESS,MAX(-MAX_STRESS,MU_DUIDXJ(ICD_SGN)))
