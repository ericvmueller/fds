...
DO NM=LOWER_MESH_INDEX,UPPER_MESH_INDEX
   ...
   CALL VELOCITY_BC(DT,T_BEGIN,NM,APPLY_TO_ESTIMATED_VARIABLES=.FALSE.)
ENDDO
...
MAIN_LOOP: DO
   ...
   VELOCITY_BC_LOOP: DO NM=LOWER_MESH_INDEX,UPPER_MESH_INDEX
      ...
      CALL VELOCITY_BC(DT,T,NM,APPLY_TO_ESTIMATED_VARIABLES=.TRUE.)
   ...
   VELOCITY_BC_LOOP_2: DO NM=LOWER_MESH_INDEX,UPPER_MESH_INDEX
      CALL VELOCITY_BC(DT,T,NM,APPLY_TO_ESTIMATED_VARIABLES=.FALSE.)
      CALL UPDATE_GLOBAL_OUTPUTS(T,DT,NM)
