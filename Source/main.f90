...
IF (MY_RANK==0) THEN
   ...
   WRITE(LU_CFL,'(I7,A,2(ES12.4,A),F6.3,A,4(I4,A),6(F7.3,A),4(ES12.4,A),F6.3,A,4(I4,A),ES12.4,A,I4,A,ES12.4,A,I4)') &
         ICYC,',',T,',',DT,',',&
         ...
         REAL_BUFFER_20(19,NM_PART_MAX),',',NM_PART_MAX,',',REAL_BUFFER_20(20,NM_DRAG_MAX),',',NM_DRAG_MAX
ENDIF
