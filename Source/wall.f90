...
IF (.NOT. (CELL(CELL_INDEX(IIG-1,JJG,KKG))%SOLID .OR. CELL(CELL_INDEX(IIG+1,JJG,KKG))%SOLID)) &
   R_DX = 1._EB / MAX(TWO_EPSILON_EB, XC(IIG+1)-XC(IIG-1))
IF (.NOT. (CELL(CELL_INDEX(IIG,JJG-1,KKG))%SOLID .OR. CELL(CELL_INDEX(IIG,JJG+1,KKG))%SOLID)) &
   R_DY = 1._EB / MAX(TWO_EPSILON_EB, YC(JJG+1)-YC(JJG-1))
IF (.NOT. (CELL(CELL_INDEX(IIG,JJG,KKG-1))%SOLID .OR. CELL(CELL_INDEX(IIG,JJG,KKG-1))%SOLID)) &
