...
REAL(EB), INTENT(IN), DIMENSION(:,:,:) :: FIELD
REAL(EB) :: GX,GY,GZ

GX = 0._EB; GY = 0._EB; GZ = 0._EB

IF (R_DX>TWO_EPSILON_EB) GX = R_DX*(FIELD(IIG+1,JJG,KKG) - FIELD(IIG-1,JJG,KKG))
IF (R_DY>TWO_EPSILON_EB) GY = R_DY*(FIELD(IIG,JJG+1,KKG) - FIELD(IIG,JJG-1,KKG))
IF (R_DZ>TWO_EPSILON_EB) GZ = R_DZ*(FIELD(IIG,JJG,KKG+1) - FIELD(IIG,JJG,KKG-1))
