...
SF%ONE_D_REALS_ARRAY_SIZE( 8) = SF%NSB                       ! IL
SF%ONE_D_REALS_ARRAY_SIZE( 9) = N_TRACKED_SPECIES            ! ZZ_G
SF%ONE_D_REALS_ARRAY_SIZE(10) = N_TRACKED_SPECIES            ! ZZ_F
SF%ONE_D_REALS_ARRAY_SIZE(11) = N_TRACKED_SPECIES            ! RHO_D_F

SF%ONE_D_INTEGERS_ARRAY_SIZE(1) = SF%N_LAYERS           ! N_LAYER_CELLS

SF%N_ONE_D_STORAGE_REALS    = N_ONE_D_SCALAR_REALS    + SUM(SF%ONE_D_REALS_ARRAY_SIZE(1:11))
...
LP%DA                => OS%REALS(18,STORAGE_INDEX) ; IF (NEW) LP%DA      = 0._EB
...
WC%U_TAU              => OS%REALS( 5,STORAGE_INDEX) ; IF (NEW) WC%U_TAU = 0._EB
WC%UVW_GHOST          => OS%REALS( 6,STORAGE_INDEX) ; IF (NEW) WC%UVW_GHOST = 0._EB
WC%UW0                => OS%REALS( 7,STORAGE_INDEX) ; IF (NEW) WC%UW0 = 0._EB
WC%XW                 => OS%REALS( 8,STORAGE_INDEX)
WC%Y_PLUS             => OS%REALS( 9,STORAGE_INDEX) ; IF (NEW) WC%Y_PLUS = 1._EB
WC%YW                 => OS%REALS(10,STORAGE_INDEX)
WC%ZW                 => OS%REALS(11,STORAGE_INDEX)
WC%VEG_HEIGHT         => OS%REALS(12,STORAGE_INDEX)
WC%VEL_ERR_NEW        => OS%REALS(13,STORAGE_INDEX) ; IF (NEW) WC%VEL_ERR_NEW = 0._EB
WC%V_DEP              => OS%REALS(14,STORAGE_INDEX) ; IF (NEW) WC%V_DEP = 0._EB
WC%Q_LEAK             => OS%REALS(15,STORAGE_INDEX) ; IF (NEW) WC%Q_LEAK = 0._EB
WC%Z_STAR             => OS%REALS(16,STORAGE_INDEX) ; IF (NEW) WC%Z_STAR = 1._EB
...
ELSE
   ...
   DO II2=1,NWP
      ...
      IF (PRESENT(MATL_INDEX)) THEN
         SURFACE_DENSITY = SURFACE_DENSITY + ONE_D%RHO(II2,MATL_INDEX)*WGT
      ELSE
