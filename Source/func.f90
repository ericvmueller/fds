...
SF%ONE_D_REALS_ARRAY_SIZE( 8) = N_TRACKED_SPECIES            ! ZZ_G
SF%ONE_D_REALS_ARRAY_SIZE( 9) = N_TRACKED_SPECIES            ! ZZ_F
SF%ONE_D_REALS_ARRAY_SIZE(10) = N_TRACKED_SPECIES            ! RHO_D_F
SF%ONE_D_REALS_ARRAY_SIZE(11) = N_TRACKED_SPECIES            ! RHO_D_DZDN_F
SF%ONE_D_REALS_ARRAY_SIZE(12) = SF%N_CELLS_MAX               ! RHO_C_S
SF%ONE_D_REALS_ARRAY_SIZE(13) = SF%N_CELLS_MAX+2             ! K_S
SF%ONE_D_REALS_ARRAY_SIZE(14) = N_SURFACE_DENSITY_SPECIES    ! AWM_AEROSOL
SF%ONE_D_REALS_ARRAY_SIZE(15) = (SF%N_CELLS_MAX+2)*SF%N_MATL ! RHO_DOT
SF%ONE_D_REALS_ARRAY_SIZE(16) = (SF%N_CELLS_MAX+2)*SF%N_SPEC ! RHO (gas)
SF%ONE_D_REALS_ARRAY_SIZE(17) = SF%N_LAYERS                  ! DDSUM
SF%ONE_D_REALS_ARRAY_SIZE(18) = SF%N_LAYERS                  ! SMALLEST_CELL_SIZE
SF%ONE_D_REALS_ARRAY_SIZE(19) = SF%N_LPC                     ! PART_MASS
SF%ONE_D_REALS_ARRAY_SIZE(20) = SF%N_LPC                     ! PART_ENTHALPY
...
!> \brief Determines the size of the BOUNDARY_PROPERTY type structure for a surface type

SUBROUTINE COMPUTE_BOUNDARY_PROPERTY_STORAGE_DIMENSIONS

USE GLOBAL_CONSTANTS, ONLY: N_LP_ARRAY_INDICES,NUMBER_SPECTRAL_BANDS,NUMBER_RADIATION_ANGLES

BOUNDARY_PROPERTY_REALS_ARRAY_SIZE(1) = N_LP_ARRAY_INDICES                             ! A_LP_MPUA
BOUNDARY_PROPERTY_REALS_ARRAY_SIZE(2) = N_LP_ARRAY_INDICES                             ! LP_CPUA
BOUNDARY_PROPERTY_REALS_ARRAY_SIZE(3) = N_LP_ARRAY_INDICES                             ! LP_MPUA
BOUNDARY_PROPERTY_REALS_ARRAY_SIZE(4) = N_LP_ARRAY_INDICES                             ! LP_TEMP
BOUNDARY_PROPERTY_REALS_ARRAY_SIZE(5) = NUMBER_RADIATION_ANGLES*NUMBER_SPECTRAL_BANDS  ! ILW
BOUNDARY_PROPERTY_REALS_ARRAY_SIZE(6) = NUMBER_SPECTRAL_BANDS                          ! IL

N_BOUNDARY_PROPERTY_STORAGE_REALS    = N_BOUNDARY_PROPERTY_SCALAR_REALS    + SUM(BOUNDARY_PROPERTY_REALS_ARRAY_SIZE(1:6))
N_BOUNDARY_PROPERTY_STORAGE_INTEGERS = N_BOUNDARY_PROPERTY_SCALAR_INTEGERS
N_BOUNDARY_PROPERTY_STORAGE_LOGICALS = N_BOUNDARY_PROPERTY_SCALAR_LOGICALS

END SUBROUTINE COMPUTE_BOUNDARY_PROPERTY_STORAGE_DIMENSIONS


!> \brief Determines the size of the BOUNDARY_COORD type structure for a surface type
...
IF (SF%INCLUDE_BOUNDARY_PROPERTY_TYPE) SF%N_WALL_STORAGE_REALS = SF%N_WALL_STORAGE_REALS + N_BOUNDARY_PROPERTY_STORAGE_REALS
IF (SF%INCLUDE_ONE_D_TYPE)             SF%N_WALL_STORAGE_REALS = SF%N_WALL_STORAGE_REALS + SF%N_ONE_D_STORAGE_REALS
...
IF (SF%INCLUDE_BOUNDARY_PROPERTY_TYPE) SF%N_WALL_STORAGE_INTEGERS=SF%N_WALL_STORAGE_INTEGERS+N_BOUNDARY_PROPERTY_STORAGE_INTEGERS
IF (SF%INCLUDE_ONE_D_TYPE)             SF%N_WALL_STORAGE_INTEGERS=SF%N_WALL_STORAGE_INTEGERS+SF%N_ONE_D_STORAGE_INTEGERS
...
IF (SF%INCLUDE_BOUNDARY_PROPERTY_TYPE) SF%N_WALL_STORAGE_LOGICALS=SF%N_WALL_STORAGE_LOGICALS+N_BOUNDARY_PROPERTY_STORAGE_LOGICALS
IF (SF%INCLUDE_ONE_D_TYPE)             SF%N_WALL_STORAGE_LOGICALS=SF%N_WALL_STORAGE_LOGICALS+SF%N_ONE_D_STORAGE_LOGICALS
...
SF => SURFACE(SURF_INDEX)
                                       ...
                                       SF%N_CFACE_STORAGE_REALS = N_CFACE_SCALAR_REALS
IF (SF%INCLUDE_BOUNDARY_COORD_TYPE)    SF%N_CFACE_STORAGE_REALS = SF%N_CFACE_STORAGE_REALS + N_BOUNDARY_COORD_STORAGE_REALS
IF (SF%INCLUDE_BOUNDARY_PROPERTY_TYPE) SF%N_CFACE_STORAGE_REALS = SF%N_CFACE_STORAGE_REALS + N_BOUNDARY_PROPERTY_STORAGE_REALS
IF (SF%INCLUDE_ONE_D_TYPE)             SF%N_CFACE_STORAGE_REALS = SF%N_CFACE_STORAGE_REALS + SF%N_ONE_D_STORAGE_REALS
...
IF (SF%INCLUDE_BOUNDARY_PROPERTY_TYPE) SF%N_CFACE_STORAGE_INTEGERS=SF%N_CFACE_STORAGE_INTEGERS+N_BOUNDARY_PROPERTY_STORAGE_INTEGERS
IF (SF%INCLUDE_ONE_D_TYPE)             SF%N_CFACE_STORAGE_INTEGERS=SF%N_CFACE_STORAGE_INTEGERS+SF%N_ONE_D_STORAGE_INTEGERS
...
IF (SF%INCLUDE_BOUNDARY_PROPERTY_TYPE) SF%N_CFACE_STORAGE_LOGICALS=SF%N_CFACE_STORAGE_LOGICALS+N_BOUNDARY_PROPERTY_STORAGE_LOGICALS
IF (SF%INCLUDE_ONE_D_TYPE)             SF%N_CFACE_STORAGE_LOGICALS=SF%N_CFACE_STORAGE_LOGICALS+SF%N_ONE_D_STORAGE_LOGICALS

END SUBROUTINE COMPUTE_CFACE_STORAGE_DIMENSIONS


!> \brief Determine the size of the LAGRAGIAN_PARTICLE type structure for the input particle class
...
IF (LPC%N_ORIENTATION>0)            LPC%N_STORAGE_REALS = LPC%N_STORAGE_REALS + NUMBER_SPECTRAL_BANDS*(NUMBER_RADIATION_ANGLES+1)
IF (SF%INCLUDE_BOUNDARY_COORD_TYPE) LPC%N_STORAGE_REALS = LPC%N_STORAGE_REALS + N_BOUNDARY_COORD_STORAGE_REALS
IF (SF%INCLUDE_ONE_D_TYPE)          LPC%N_STORAGE_REALS = LPC%N_STORAGE_REALS + SF%N_ONE_D_STORAGE_REALS

                                    LPC%N_STORAGE_INTEGERS = N_PARTICLE_SCALAR_INTEGERS
IF (SF%INCLUDE_BOUNDARY_COORD_TYPE) LPC%N_STORAGE_INTEGERS = LPC%N_STORAGE_INTEGERS + N_BOUNDARY_COORD_STORAGE_INTEGERS
IF (SF%INCLUDE_ONE_D_TYPE)          LPC%N_STORAGE_INTEGERS = LPC%N_STORAGE_INTEGERS + SF%N_ONE_D_STORAGE_INTEGERS

                                    LPC%N_STORAGE_LOGICALS = N_PARTICLE_SCALAR_LOGICALS
IF (SF%INCLUDE_BOUNDARY_COORD_TYPE) LPC%N_STORAGE_LOGICALS = LPC%N_STORAGE_LOGICALS + N_BOUNDARY_COORD_STORAGE_LOGICALS
IF (SF%INCLUDE_ONE_D_TYPE)          LPC%N_STORAGE_LOGICALS = LPC%N_STORAGE_LOGICALS + SF%N_ONE_D_STORAGE_LOGICALS
...
USE GLOBAL_CONSTANTS, ONLY: SIGMA,TMPA4,RPI,DIRICHLET,INITIALIZATION_PHASE,PERIODIC_TEST,TMPA
...
ELSEIF (PRESENT(WALL_INDEX).OR.PRESENT(CFACE_INDEX)) THEN
...
! If there is an existing storage slot for a WALL, use it
...
! If there is an existing storage slot for a CFACE, use it

IF (PRESENT(CFACE_INDEX) .AND. .NOT.INITIALIZATION_PHASE) THEN
   DO I=1,OS%N_STORAGE_SLOTS
      IF (OS%INTEGERS(1,I)==CFACE_INDEX) THEN
         STORAGE_INDEX_OLD = I
         EXIT
      ENDIF
   ENDDO
...
IC=IC+1 ; LP%TAG                 => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) LP%TAG = TAG
IC=IC+1 ; LP%ARRAY_INDEX         => OS%INTEGERS(IC,STORAGE_INDEX) ;          LP%ARRAY_INDEX = LP_INDEX_LOCAL
IC=IC+1 ; LP%STORAGE_INDEX       => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) LP%STORAGE_INDEX = STORAGE_INDEX
IC=IC+1 ; LP%CLASS_INDEX         => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) LP%CLASS_INDEX = LPC_INDEX
IC=IC+1 ; LP%ORIENTATION_INDEX   => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) LP%ORIENTATION_INDEX = 0
IC=IC+1 ; LP%WALL_INDEX          => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) LP%WALL_INDEX = 0
IC=IC+1 ; LP%DUCT_INDEX          => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) LP%DUCT_INDEX = 0
IC=IC+1 ; LP%DUCT_CELL_INDEX     => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) LP%DUCT_CELL_INDEX = 0
IC=IC+1 ; LP%INIT_INDEX          => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) LP%INIT_INDEX = 0
IC=IC+1 ; LP%CFACE_INDEX         => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) LP%CFACE_INDEX = 0
IC=IC+1 ; LP%PROP_INDEX          => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) LP%PROP_INDEX = 0

! Assign logical pointers and values

LC = 0

LC=LC+1 ; LP%SHOW              => OS%LOGICALS(LC,STORAGE_INDEX) ; IF (NEW) LP%SHOW  = .FALSE.
LC=LC+1 ; LP%SPLAT             => OS%LOGICALS(LC,STORAGE_INDEX) ; IF (NEW) LP%SPLAT = .FALSE.
LC=LC+1 ; LP%EMBER             => OS%LOGICALS(LC,STORAGE_INDEX) ; IF (NEW) LP%EMBER = .FALSE.
LC=LC+1 ; LP%PATH_PARTICLE     => OS%LOGICALS(LC,STORAGE_INDEX) ; IF (NEW) LP%PATH_PARTICLE = .FALSE.

! Assign real pointers and values

RC = 0

RC=RC+1 ; LP%U                 => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) LP%U       = 0._EB
RC=RC+1 ; LP%V                 => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) LP%V       = 0._EB
RC=RC+1 ; LP%W                 => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) LP%W       = 0._EB
RC=RC+1 ; LP%PWT               => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) LP%PWT     = 1._EB
RC=RC+1 ; LP%ACCEL_X           => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) LP%ACCEL_X = 0._EB
RC=RC+1 ; LP%ACCEL_Y           => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) LP%ACCEL_Y = 0._EB
RC=RC+1 ; LP%ACCEL_Z           => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) LP%ACCEL_Z = 0._EB
RC=RC+1 ; LP%RE                => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) LP%RE      = 0._EB
RC=RC+1 ; LP%MASS              => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) LP%MASS    = 0._EB
RC=RC+1 ; LP%T_INSERT          => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) LP%T_INSERT= 0._EB
RC=RC+1 ; LP%DX                => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) LP%DX      = 0._EB
RC=RC+1 ; LP%DY                => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) LP%DY      = 0._EB
RC=RC+1 ; LP%DZ                => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) LP%DZ      = 0._EB
RC=RC+1 ; LP%M_DOT             => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) LP%M_DOT   = 0._EB
RC=RC+1 ; LP%HTC_LIMIT         => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) LP%HTC_LIMIT=1.E6_EB
RC=RC+1 ; LP%C_DRAG            => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) LP%C_DRAG  = 0._EB
RC=RC+1 ; LP%ZI                => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) LP%ZI      = 0._EB

! Add arrays for radiation

IF (LPC%N_ORIENTATION>0) THEN

   I2 = RC

   IF (ALLOCATED(LP%BAND)) DEALLOCATE(LP%BAND)
   ALLOCATE(LP%BAND(NUMBER_SPECTRAL_BANDS))
   DO NN=1,NUMBER_SPECTRAL_BANDS
      I1 = I2+1 ; I2 = I1 + NUMBER_RADIATION_ANGLES - 1
      LP%BAND(NN)%ILW(1:NUMBER_RADIATION_ANGLES) => OS%REALS(I1:I2,STORAGE_INDEX)
      IF (NEW) LP%BAND(NN)%ILW(1:NUMBER_RADIATION_ANGLES) = 0._EB
   ENDDO

   I1 = I2+1 ; I2 = I1 + NUMBER_SPECTRAL_BANDS - 1
   LP%IL(1:I2-I1+1) => OS%REALS(I1:I2,STORAGE_INDEX)
   IF (NEW) LP%IL(1:NUMBER_SPECTRAL_BANDS) = SIGMA*TMPA4/PI
...
IF (SF%INCLUDE_BOUNDARY_COORD_TYPE) CALL BOUNDARY_COORD_POINTERS(LP_INDEX_LOCAL,NEW)
IF (SF%INCLUDE_ONE_D_TYPE)          CALL ONE_D_POINTERS(LP_INDEX_LOCAL,NEW)
...
IC=IC+1 ; WC%WALL_INDEX         => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) WC%WALL_INDEX = WALL_INDEX_LOCAL
IC=IC+1 ; WC%SURF_INDEX         => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) WC%SURF_INDEX = SURF_INDEX
IC=IC+1 ; WC%BACK_INDEX         => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) WC%BACK_INDEX = 0
IC=IC+1 ; WC%BACK_MESH          => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) WC%BACK_MESH  = NM
IC=IC+1 ; WC%BOUNDARY_TYPE      => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) WC%BOUNDARY_TYPE = NULL_BOUNDARY
IC=IC+1 ; WC%SURF_INDEX_ORIG    => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) WC%SURF_INDEX_ORIG = 0
IC=IC+1 ; WC%OBST_INDEX         => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) WC%OBST_INDEX = 0
IC=IC+1 ; WC%PRESSURE_BC_INDEX  => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) WC%PRESSURE_BC_INDEX = DIRICHLET
IC=IC+1 ; WC%VENT_INDEX         => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) WC%VENT_INDEX = 0
IC=IC+1 ; WC%JD11_INDEX         => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) WC%JD11_INDEX = 0
IC=IC+1 ; WC%JD12_INDEX         => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) WC%JD12_INDEX = 0
IC=IC+1 ; WC%JD21_INDEX         => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) WC%JD21_INDEX = 0
IC=IC+1 ; WC%JD22_INDEX         => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) WC%JD22_INDEX = 0
IC=IC+1 ; WC%CUT_FACE_INDEX     => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) WC%CUT_FACE_INDEX = 0

! Assign and initialize reals

RC = 0

RC=RC+1 ; WC%DUNDT              => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) WC%DUNDT = 0._EB
RC=RC+1 ; WC%VEL_ERR_NEW        => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) WC%VEL_ERR_NEW = 0._EB
RC=RC+1 ; WC%V_DEP              => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) WC%V_DEP = 0._EB
RC=RC+1 ; WC%Q_LEAK             => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) WC%Q_LEAK = 0._EB

! Assign and initialize logicals

LC = 0

! Add ONE_D (interior) parameters and BOUNDARY_PROPERTY (exterior) parameters

IF (SF%INCLUDE_BOUNDARY_COORD_TYPE)    CALL BOUNDARY_COORD_POINTERS(WALL_INDEX_LOCAL,NEW)
IF (SF%INCLUDE_ONE_D_TYPE)             CALL ONE_D_POINTERS(WALL_INDEX_LOCAL,NEW)
IF (SF%INCLUDE_BOUNDARY_PROPERTY_TYPE) CALL BOUNDARY_PROPERTY_POINTERS(WALL_INDEX_LOCAL,NEW)
...
IC=IC+1 ; CFA%CFACE_INDEX        => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) CFA%CFACE_INDEX   = CFACE_INDEX_LOCAL
IC=IC+1 ; CFA%SURF_INDEX         => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) CFA%SURF_INDEX    = SURF_INDEX
IC=IC+1 ; CFA%VENT_INDEX         => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) CFA%VENT_INDEX    = 0
IC=IC+1 ; CFA%BACK_INDEX         => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) CFA%BACK_INDEX    = 0
IC=IC+1 ; CFA%BACK_MESH          => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) CFA%BACK_MESH     = NM
IC=IC+1 ; CFA%BOUNDARY_TYPE      => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) CFA%BOUNDARY_TYPE = NULL_BOUNDARY
IC=IC+1 ; CFA%CUT_FACE_IND1      => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) CFA%CUT_FACE_IND1 = -11
IC=IC+1 ; CFA%CUT_FACE_IND2      => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) CFA%CUT_FACE_IND2 = -11

! Assign and initialize reals

RC = 0

RC=RC+1 ; CFA%AREA               => OS%REALS(RC,STORAGE_INDEX)
RC=RC+1 ; CFA%NVEC(1:3)          => OS%REALS(RC:RC+2,STORAGE_INDEX) ; RC=RC+2
RC=RC+1 ; CFA%VEL_ERR_NEW        => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) CFA%VEL_ERR_NEW = 0._EB
RC=RC+1 ; CFA%V_DEP              => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) CFA%V_DEP       = 0._EB
RC=RC+1 ; CFA%Q_LEAK             => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) CFA%Q_LEAK      = 0._EB
RC=RC+1 ; CFA%DUNDT              => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) CFA%DUNDT       = 0._EB

! Assign and initialize logicals

LC = 0

! Add ONE_D and BOUNDARY_PROPERTY parameters

IF (SF%INCLUDE_BOUNDARY_COORD_TYPE)    CALL BOUNDARY_COORD_POINTERS(CFACE_INDEX_LOCAL,NEW)
IF (SF%INCLUDE_ONE_D_TYPE)             CALL ONE_D_POINTERS(CFACE_INDEX_LOCAL,NEW)
IF (SF%INCLUDE_BOUNDARY_PROPERTY_TYPE) CALL BOUNDARY_PROPERTY_POINTERS(CFACE_INDEX_LOCAL,NEW)

END SUBROUTINE CFACE_POINTERS


!> \brief Assign pointers for variables associated with BOUNDARY_COORD_TYPE of a WALL, CFACE, or LAGRANGIAN_PARTICLE
!> \param INDEX_LOCAL Index of the WALL, CFACE, or LAGRANGIAN_PARTICLE
!> \param NEW Logical parameter indicating if the WALL, CFACE, or LAGRANGIAN_PARTICLE is new

SUBROUTINE BOUNDARY_COORD_POINTERS(INDEX_LOCAL,NEW)

INTEGER, INTENT(IN) :: INDEX_LOCAL
LOGICAL, INTENT(IN) :: NEW
TYPE(BOUNDARY_COORD_TYPE), POINTER :: BC

IF (PRESENT(WALL_INDEX)) THEN
   BC=>MESHES(NM)%WALL(INDEX_LOCAL)%BOUNDARY_COORD
ELSEIF (PRESENT(CFACE_INDEX)) THEN
   BC=>MESHES(NM)%CFACE(INDEX_LOCAL)%BOUNDARY_COORD
ELSEIF(PRESENT(LP_INDEX)) THEN
   BC=>MESHES(NM)%LAGRANGIAN_PARTICLE(INDEX_LOCAL)%BOUNDARY_COORD
ENDIF

! Assign and initialize integers

IC=IC+1 ; BC%II              => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) BC%II            = 0
IC=IC+1 ; BC%JJ              => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) BC%JJ            = 0
IC=IC+1 ; BC%KK              => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) BC%KK            = 0
IC=IC+1 ; BC%IIG             => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) BC%IIG           = 0
IC=IC+1 ; BC%JJG             => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) BC%JJG           = 0
IC=IC+1 ; BC%KKG             => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) BC%KKG           = 0
IC=IC+1 ; BC%IOR             => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) BC%IOR           = 0

RC=RC+1 ; BC%X               => OS%REALS(RC,STORAGE_INDEX)
RC=RC+1 ; BC%Y               => OS%REALS(RC,STORAGE_INDEX)
RC=RC+1 ; BC%Z               => OS%REALS(RC,STORAGE_INDEX)

END SUBROUTINE BOUNDARY_COORD_POINTERS
...
SUBROUTINE ONE_D_POINTERS(ONE_D_INDEX_LOCAL,NEW)

USE GLOBAL_CONSTANTS, ONLY: RADIATION,TMPM,RHOA,RSUM0,THERMALLY_THICK
INTEGER, INTENT(IN) :: ONE_D_INDEX_LOCAL
LOGICAL, INTENT(IN) :: NEW
INTEGER :: N,NN
REAL(EB) :: X_POS
...
IC=IC+1 ; ONE_D%PRESSURE_ZONE   => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) ONE_D%PRESSURE_ZONE = 0
IC=IC+1 ; ONE_D%NODE_INDEX      => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) ONE_D%NODE_INDEX    = 0
IC=IC+1 ; ONE_D%N_SUBSTEPS      => OS%INTEGERS(IC,STORAGE_INDEX) ; IF (NEW) ONE_D%N_SUBSTEPS    = 1
...
LC=LC+1 ; ONE_D%BURNAWAY        => OS%LOGICALS(LC,STORAGE_INDEX) ; IF (NEW) ONE_D%BURNAWAY = .FALSE.

! Assign and initialize reals

RC=RC+1 ; ONE_D%AREA            => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%AREA            = 0._EB
RC=RC+1 ; ONE_D%HEAT_TRANS_COEF => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%HEAT_TRANS_COEF = 0._EB
RC=RC+1 ; ONE_D%Q_CON_F         => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%Q_CON_F         = 0._EB
RC=RC+1 ; ONE_D%Q_RAD_IN        => OS%REALS(RC,STORAGE_INDEX)
RC=RC+1 ; ONE_D%Q_RAD_OUT       => OS%REALS(RC,STORAGE_INDEX)
IF (RADIATION) THEN
   IF (NEW) ONE_D%Q_RAD_IN        = SF%EMISSIVITY*SIGMA*TMPA4
   IF (NEW) ONE_D%Q_RAD_OUT       = SF%EMISSIVITY*SIGMA*TMPA4
ELSE
   IF (NEW) ONE_D%Q_RAD_IN        = 0._EB
   IF (NEW) ONE_D%Q_RAD_OUT       = 0._EB
ENDIF
RC=RC+1 ; ONE_D%EMISSIVITY      => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%EMISSIVITY      = SF%EMISSIVITY
RC=RC+1 ; ONE_D%AREA_ADJUST     => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%AREA_ADJUST     = 1._EB
RC=RC+1 ; ONE_D%T_IGN           => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%T_IGN           = SF%T_IGN
RC=RC+1 ; ONE_D%TMP_F           => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%TMP_F           = SF%TMP_FRONT
RC=RC+1 ; ONE_D%TMP_B           => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%TMP_B           = SF%TMP_INNER(SF%N_LAYERS)
RC=RC+1 ; ONE_D%U_NORMAL        => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%U_NORMAL        = 0._EB
RC=RC+1 ; ONE_D%U_NORMAL_S      => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%U_NORMAL_S      = 0._EB
RC=RC+1 ; ONE_D%U_NORMAL_0      => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%U_NORMAL_0      = 0._EB
RC=RC+1 ; ONE_D%RSUM_G          => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%RSUM_G          = RSUM0
RC=RC+1 ; ONE_D%TMP_G           => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%TMP_G           = TMPA
RC=RC+1 ; ONE_D%RHO_G           => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%RHO_G           = RHOA
RC=RC+1 ; ONE_D%U_TANG          => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%U_TANG          = 0._EB
RC=RC+1 ; ONE_D%RHO_F           => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%RHO_F           = RHOA
RC=RC+1 ; ONE_D%RDN             => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%RDN             = 1._EB
RC=RC+1 ; ONE_D%MU_G            => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%MU_G            = 0.1_EB
RC=RC+1 ; ONE_D%K_G             => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%K_G             = 0.1_EB
RC=RC+1 ; ONE_D%Q_DOT_G_PP      => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%Q_DOT_G_PP      = 0._EB
RC=RC+1 ; ONE_D%Q_DOT_O2_PP     => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%Q_DOT_O2_PP     = 0._EB
RC=RC+1 ; ONE_D%Q_CONDENSE      => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%Q_CONDENSE      = 0._EB
RC=RC+1 ; ONE_D%TMP_F_OLD       => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%TMP_F_OLD       = SF%TMP_FRONT
RC=RC+1 ; ONE_D%BURN_DURATION   => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%BURN_DURATION   = SF%BURN_DURATION
RC=RC+1 ; ONE_D%T_SCALE         => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%T_SCALE         = 0._EB
RC=RC+1 ; ONE_D%Q_SCALE         => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%Q_SCALE         = 0._EB
RC=RC+1 ; ONE_D%T_MATL_PART     => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%T_MATL_PART     = 0._EB
RC=RC+1 ; ONE_D%B_NUMBER        => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) ONE_D%B_NUMBER        = 0._EB
...
DO NN=1,SF%N_SPEC
   I1 = I2+1 ; I2 = I1 + (SF%N_CELLS_MAX+2) - 1
   ONE_D%SPEC_COMP(NN)%RHO_ZZ(0:SF%N_CELLS_MAX+1) => OS%REALS(I1:I2,STORAGE_INDEX)
   IF (NEW) ONE_D%SPEC_COMP(NN)%RHO_ZZ(0:SF%N_CELLS_INI+1) = SF%PHIRHOZ_0(0:SF%N_CELLS_INI+1,NN)
ENDDO

I1 = I2+1 ; I2 = I1 + SF%ONE_D_REALS_ARRAY_SIZE(17) - 1
ONE_D%DDSUM(1:I2-I1+1) => OS%REALS(I1:I2,STORAGE_INDEX)
IF (NEW) ONE_D%DDSUM(1:SF%N_LAYERS) = SF%DDSUM(1:SF%N_LAYERS)

I1 = I2+1 ; I2 = I1 + SF%ONE_D_REALS_ARRAY_SIZE(18) - 1
ONE_D%SMALLEST_CELL_SIZE(1:I2-I1+1) => OS%REALS(I1:I2,STORAGE_INDEX)
IF (NEW) ONE_D%SMALLEST_CELL_SIZE(1:SF%N_LAYERS) = SF%SMALLEST_CELL_SIZE(1:SF%N_LAYERS)

I1 = I2+1 ; I2 = I1 + SF%ONE_D_REALS_ARRAY_SIZE(19) - 1
ONE_D%PART_MASS(1:I2-I1+1) => OS%REALS(I1:I2,STORAGE_INDEX)
IF (NEW) ONE_D%PART_MASS(1:SF%N_LPC) = 0._EB

I1 = I2+1 ; I2 = I1 + SF%ONE_D_REALS_ARRAY_SIZE(20) - 1
ONE_D%PART_ENTHALPY(1:I2-I1+1) => OS%REALS(I1:I2,STORAGE_INDEX)
IF (NEW) ONE_D%PART_ENTHALPY(1:SF%N_LPC) = 0._EB

RC = I2  ! Update the Real Counter

END SUBROUTINE ONE_D_POINTERS


!> \brief Assign pointers for variables associated with the BOUNDARY_PROPERTY derived type variable of a WALL or CFACE
!> \param INDEX_LOCAL Index of the WALL or CFACE
!> \param NEW Logical parameter indicating if the WALL or CFACE is new

SUBROUTINE BOUNDARY_PROPERTY_POINTERS(INDEX_LOCAL,NEW)
...
IF (PRESENT(WALL_INDEX)) THEN
   BP=>MESHES(NM)%WALL(INDEX_LOCAL)%BOUNDARY_PROPERTY
ELSEIF (PRESENT(CFACE_INDEX)) THEN
   BP=>MESHES(NM)%CFACE(INDEX_LOCAL)%BOUNDARY_PROPERTY
ENDIF

! RC is the number of reals already allocated to the WALL or CFACE storage bin

RC=RC+1 ; BP%U_TAU           => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) BP%U_TAU = 0._EB
RC=RC+1 ; BP%Y_PLUS          => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) BP%Y_PLUS = 1._EB
RC=RC+1 ; BP%Z_STAR          => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) BP%Z_STAR = 1._EB
RC=RC+1 ; BP%PHI_LS          => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) BP%PHI_LS = -1._EB
RC=RC+1 ; BP%WORK1           => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) BP%WORK1 = 0._EB
RC=RC+1 ; BP%WORK2           => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) BP%WORK2 = 0._EB
RC=RC+1 ; BP%K_SUPPRESSION   => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) BP%K_SUPPRESSION   = 0._EB
RC=RC+1 ; BP%L_OBUKHOV       => OS%REALS(RC,STORAGE_INDEX) ; IF (NEW) BP%L_OBUKHOV       = 0._EB

I2 = RC

I1 = I2+1 ; I2 = I1 + BOUNDARY_PROPERTY_REALS_ARRAY_SIZE(1) - 1
BP%A_LP_MPUA(1:I2-I1+1) => OS%REALS(I1:I2,STORAGE_INDEX)
IF (NEW) BP%A_LP_MPUA(1:I2-I1+1) = 0._EB

I1 = I2+1 ; I2 = I1 + BOUNDARY_PROPERTY_REALS_ARRAY_SIZE(2) - 1
BP%LP_CPUA(1:I2-I1+1) => OS%REALS(I1:I2,STORAGE_INDEX)
IF (NEW) BP%LP_CPUA(1:I2-I1+1) = 0._EB

I1 = I2+1 ; I2 = I1 + BOUNDARY_PROPERTY_REALS_ARRAY_SIZE(3) - 1
BP%LP_MPUA(1:I2-I1+1) => OS%REALS(I1:I2,STORAGE_INDEX)
IF (NEW) BP%LP_MPUA(1:I2-I1+1) = 0._EB

I1 = I2+1 ; I2 = I1 + BOUNDARY_PROPERTY_REALS_ARRAY_SIZE(4) - 1
BP%LP_TEMP(1:I2-I1+1) => OS%REALS(I1:I2,STORAGE_INDEX)
IF (NEW) BP%LP_TEMP(1:I2-I1+1) = TMPA

IF (ALLOCATED(BP%BAND)) DEALLOCATE(BP%BAND)
ALLOCATE(BP%BAND(NUMBER_SPECTRAL_BANDS))
DO NN=1,NUMBER_SPECTRAL_BANDS
   I1 = I2+1 ; I2 = I1 + NUMBER_RADIATION_ANGLES - 1
   BP%BAND(NN)%ILW(1:NUMBER_RADIATION_ANGLES) => OS%REALS(I1:I2,STORAGE_INDEX)
   IF (NEW) BP%BAND(NN)%ILW(1:NUMBER_RADIATION_ANGLES) = 0._EB
ENDDO

I1 = I2+1 ; I2 = I1 + BOUNDARY_PROPERTY_REALS_ARRAY_SIZE(6) - 1
BP%IL(1:I2-I1+1) => OS%REALS(I1:I2,STORAGE_INDEX)
IF (NEW) BP%IL(1:NUMBER_SPECTRAL_BANDS) = SIGMA*TMPA4/PI

RC = I2

END SUBROUTINE BOUNDARY_PROPERTY_POINTERS
...
DO K=0,M%KBP1
   M%U_WIND(K) = U0*EVALUATE_RAMP(T,I_RAMP_U0_T)*EVALUATE_RAMP(M%ZC(K),I_RAMP_U0_Z)
   M%V_WIND(K) = V0*EVALUATE_RAMP(T,I_RAMP_V0_T)*EVALUATE_RAMP(M%ZC(K),I_RAMP_V0_Z)
...
USE MESH_VARIABLES
USE GLOBAL_CONSTANTS, ONLY: MY_RANK,PROCESS,EVAC_PROCESS
INTEGER, INTENT(IN) :: NM
INTEGER :: N
...
ENDDO
IF (MY_RANK==PROCESS(NM) .OR. MY_RANK==EVAC_PROCESS) PROCESS_MESH_NEIGHBORHOOD = .TRUE.
