...
SF%ONE_D_REALS_ARRAY_SIZE(14) = SF%N_CELLS_MAX               ! RHO_C_S
SF%ONE_D_REALS_ARRAY_SIZE(15) = SF%N_CELLS_MAX+2             ! K_S
SF%ONE_D_REALS_ARRAY_SIZE(16) = N_SURFACE_DENSITY_SPECIES    ! AWM_AEROSOL
SF%ONE_D_REALS_ARRAY_SIZE(17) = (SF%N_CELLS_MAX+2)*SF%N_MATL ! RHO_DOT
SF%ONE_D_REALS_ARRAY_SIZE(18) = (SF%N_CELLS_MAX+2)*SF%N_SPEC ! RHO (gas)
SF%ONE_D_REALS_ARRAY_SIZE(19) = SF%N_LAYERS                  ! DDSUM
SF%ONE_D_REALS_ARRAY_SIZE(20) = SF%N_LAYERS                  ! SMALLEST_CELL_SIZE
SF%ONE_D_REALS_ARRAY_SIZE(21) = SF%N_LPC                     ! PART_MASS
SF%ONE_D_REALS_ARRAY_SIZE(22) = SF%N_LPC                     ! PART_ENTHALPY
...
N_BOUNDARY_PROPERTY_STORAGE_REALS    = N_BOUNDARY_PROPERTY_SCALAR_REALS    + SUM(BOUNDARY_PROPERTY_REALS_ARRAY_SIZE(1:4))
...
ONE_D%B_NUMBER        => OS%REALS(RC+38,STORAGE_INDEX) ; IF (NEW) ONE_D%B_NUMBER        = 0._EB
...
I2 = RC  ! RC is the number of reals already allocated to the WALL or CFACE storage bin
